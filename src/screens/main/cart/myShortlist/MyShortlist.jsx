...
import { styles } from './MyShortlist.style';
import {
  userCartData,
...
const MyShortlist = () => {
  ...
  const onCheckout = async () => {
    ...
    if (updatedSelectedItems.length > 0) {
      ...
      // Save selected cart items to AsyncStorage
          ...
          {cart && cart.length === 0 ? null : (
            <View style={styles.checkboxContainer}>
              ...
              <AppButton
                ...
                imageLeft
                background
                buttonContainerStyle={styles.deleteBtnAllContainerStyle}
                textStyle={styles.deleteAllTextStyle}
                  ...
                  return (
                    <View style={styles.cartRoot}>
                      ...
                      <View style={styles.buttonsView}>
                        <AppButton
                          ImageSource={<icons.ShoppingIcon width={13} height={13} />}
                          label="Move to Cart"
                          image
                          imageLeft
                          background
                          buttonContainerStyle={styles.editBtnContainerStyle}
                          textStyle={styles.editTextStyle}
                        // onPress={() => handleDeleteButton(item.id)}
                        />
                        <AppButton
                          ImageSource={<icons.DeleteIconRed width={13} height={13} />}
                          label="Delete"
                          image
                          imageLeft
                          background
              ...
              <View style={styles.footerRoot}>
                <View style={styles.finalPaymentdetails}>
                  <View style={styles.paymentInfoView}>
                    <Text style={styles.paymentInfoText}>Subtotal ({'1 items'})</Text>
