...
import { Text, View, StatusBar, TextInput, TouchableOpacity, TouchableWithoutFeedback, Keyboard, Platform } from 'react-native'
...
import { addAddress, getUserDetails } from '../../../../redux/features/auth/authThunks';
...
const AddAddress = () => {
  ...
  const onSubmit = async (data) => {
    const address_type = addressType === "home" ? "home" : addressType === "office" ? "office" : "";
    const newData = { ...data, address_type, is_default: isDefault, country: 'Pakistan' };
    try {
      setButtonLoading(true);
      const successMessage = await dispatch(addAddress({ data: newData, setModalVisible }));
        ...
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          <View style={styles.addAddressContainer}>
            <View style={styles.fieldsRoot}>
              ...
              {errors.contact_person_name && <Text style={styles.validationText}>{errors.contact_person_name.message}</Text>}
              <View style={styles.field}>
                <Controller
                  name="appartment_no"
                  control={control}
              ...
              {errors.appartment_no && <Text style={styles.validationText}>{errors.appartment_no.message}</Text>}
              <View style={styles.field}>
                <Controller
                  name="street_address"
                  control={control}
              ...
              {errors.street_address && <Text style={styles.validationText}>{errors.street_address.message}</Text>}
              <View style={styles.field}>
                <Controller
                  name="zip"
                  control={control}
              ...
              {errors.city && <Text style={styles.validationText}>{errors.city.message}</Text>}
              <View style={styles.field}>
                <Controller
                  name="state"
                  control={control}
              ...
              {errors.state && <Text style={styles.validationText}>{errors.state.message}</Text>}
              ...
              {errors.phone && <Text style={styles.validationText}>{errors.phone.message}</Text>}
            </View>
